...
MACRO (DEFINE_Connext_SOURCES idlfilename)
	...
	SET(outsources ${outsources} ${PROJECT_SOURCE_DIR}/gen/${nfile}Impl.cxx ${PROJECT_SOURCE_DIR}/gen/${nfile}Impl.hpp)
	SET(outsources ${outsources} ${PROJECT_SOURCE_DIR}/gen/${nfile}ImplPlugin.cxx ${PROJECT_SOURCE_DIR}/gen/${nfile}ImplPlugin.hpp)
	SET(outsources ${outsources} ${PROJECT_SOURCE_DIR}/gen/${nfile}ImplSupport.cxx ${PROJECT_SOURCE_DIR}/gen/${nfile}ImplSupport.hpp)
